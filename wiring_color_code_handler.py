from constant import MAJOR_COLORS, MINOR_COLORS

def get_color_pair_from_pair_number(pair_number):
...
def get_pair_number_from_color_pair(major_color, minor_color):
    try:
